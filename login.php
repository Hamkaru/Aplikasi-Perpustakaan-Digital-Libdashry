...
<html lang="en">
    <head>
        ...
        <title>Libdashry Login</title>
        <link href="css/styles.css" rel="stylesheet" />
        <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
    </head>
    <body class="bg-primary">
        <div id="layoutAuthentication" style="background-color: lightskyblue">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Login Libdashry</h3></div>
                                    <div class="card-body">
                                        <?php
                                            if(isset($_POST['login'])) {
                                                ...
                                                if($cek > 0){
                                                    ...
                                                    echo '<script>alert("Selamat datang di Libdashry!"); location.href="index.php"</script>';
                                                }else{
                                        ...
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputUsername" required name="username" type="text" class="text-muted" placeholder="Username">
